...
export BOTTOMMENU_ITEMS=${BOTTOMMENU_ITEMS:-'[{"label": "Home", "icon": {"type": "preset", "name": "home_outlined"}, "url": "https://pixaware.co/"}, {"label": "Solutions", "icon": {"type": "preset", "name": "build"}, "url": "https://pixaware.co/solutions/"}, {"label": "About", "icon": {"type": "preset", "name": "info"}, "url": "https://pixaware.co/who-we-are/"}, {"label": "Contact", "icon": {"type": "preset", "name": "phone"}, "url": "https://pixaware.co/lets-talk/"}]'}
...
export KEY_STORE_URL=${KEY_STORE_URL:-"https://raw.githubusercontent.com/prasanna91/QuikApp/main/keystore.jks"}
...
#export BOTTOMMENU_ITEMS='[{"label": "Home", "icon": {"type": "preset", "name": "home_outlined"}, "url": "https://test.pixaware.co/"}]'
