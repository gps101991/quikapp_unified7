...
# Optimized iOS Workflow Script with Correct Firebase Setup Order
# Uses Codemagic CLI keychain commands for reliable code signing
# Firebase setup is integrated at the correct step in the workflow
...
echo "🚀 Starting Optimized iOS Workflow with Firebase Integration..."
...
echo "📝 Step 2: Generate environment configuration..."
...
# Step 3: Firebase Setup (CRITICAL: Must be before CocoaPods)
echo "🔥 Step 3: Firebase Setup and Configuration..."
...
# Step 4: Generate Podfile dynamically (after Firebase setup)
echo "📦 Step 4: Generating Podfile dynamically..."
...
# Step 5: Code Signing Setup
echo "🔐 Step 5: Code Signing Setup..."
...
# Step 6: App Customization
echo "🎨 Step 6: App Customization and Branding..."
...
# Step 7: iOS Permissions Configuration
echo "🔐 Step 7: iOS Permissions Configuration..."
...
# Step 8: Flutter Dependencies and Project Setup
echo "📦 Step 8: Flutter Dependencies and Project Setup..."
...
# Step 9: CocoaPods Setup (after Firebase configuration)
echo "📦 Step 9: CocoaPods Setup and Dependencies..."
...
# Step 10: Xcode Configuration
echo "⚙️ Step 10: Xcode Configuration and Code Signing..."
...
# Step 12: IPA Export
echo "📤 Step 12: IPA Export and Finalization..."
